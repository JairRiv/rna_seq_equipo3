...
## Análisis de expresión diferencial y análisis de enriquecimiento
...
::: {style="display: flex; gap: 10px; align-items: flex-start;"}
<img src="./figures/barplot_UP_A1G_vs_GC.png" style="width: 400px;"/>
:::
...
::: {style="display: flex; gap: 10px; align-items: flex-start;"}
<img src="./figures/barplotDOWN_GO_A1G_vs_GC.png" style="width: 400px;"/>
:::
